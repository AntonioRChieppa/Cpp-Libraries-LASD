...
public:
  ...
  // Specific member functions (funzioni della classe)

  // type Empty() specifiers; // (concrete function should not throw exceptions) virtual
  inline virtual bool Empty() const noexcept {
    return (size == 0);
  }

  // type Size() specifiers; // (concrete function should not throw exceptions) virtual
